...
import geschaeftsobjekt.Rechnung;
import geschaeftsobjekt.Rechnungsstatus;
...
public class ExceptionTest {
	...
	public void testOutOfStockException() {
		...
		Class<?>[] types = c.getParameterTypes();
		if (types.length != 2 || 
				!types[0].getName().equals("geschaeftsobjekt.Produkt") ||
		...
		if (!fields[0].getType().getName().equals("geschaeftsobjekt.Produkt")) {
